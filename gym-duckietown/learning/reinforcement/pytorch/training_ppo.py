...
def main(args):
    ...
    envs = launch_env()
    print("Initialized envsironment")
    ...
    # envs = make_vec_envs(args.envs_name, args.seed, args.num_processes,
    ...
    for j in range(num_updates):
        ...
        if (j % args.save_interval == 0
            ...
            ], os.path.join(save_path, args.envs_name + ".pt"))
        ...
        if (args.eval_interval is not None and len(episode_rewards) > 1
            ...
            evaluate(actor_critic, obs_rms, args.envs_name, args.seed,
